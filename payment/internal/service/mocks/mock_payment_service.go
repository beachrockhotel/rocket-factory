...
import (
	...
	model "github.com/beachrockhotel/rocket-factory/payment/internal/model"
...
func (_m *PaymentService) PayOrder(ctx context.Context, req model.PayOrderRequest) (string, error) {
