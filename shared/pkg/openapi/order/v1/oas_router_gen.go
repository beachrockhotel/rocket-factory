...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		switch elem[0] {
		case '/': // Prefix: "/api/grpc/orders"

			if l := len("/api/grpc/orders"); len(elem) >= l && elem[0:l] == "/api/grpc/orders" {
				elem = elem[l:]
			} else {
				break
			}
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.pathPattern = "/api/grpc/orders/{order_uuid}"
						r.args = args
						r.count = 1
						return r, true
					default:
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.pathPattern = "/api/grpc/orders/{order_uuid}/cancel"
								r.args = args
								r.count = 1
								return r, true
							default:
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.pathPattern = "/api/grpc/orders/{order_uuid}/pay"
								r.args = args
								r.count = 1
								return r, true
							default:
