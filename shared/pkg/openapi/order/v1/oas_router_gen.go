				...
				case '/': // Prefix: "/"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handleCreatePaymentRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "POST")
		...
		case '/': // Prefix: "/api/v1/orders"
			...
			if len(elem) == 0 {
				...
				case "POST":
					...
					r.summary = "Create order based on the details selected by user"
				...
				case '/': // Prefix: "/"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = CreatePaymentOperation
								r.summary = "Makes payment for the created order"
