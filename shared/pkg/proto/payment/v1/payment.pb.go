...
// 	protoc        (unknown)
// source: repository/grpc/repository.proto
...
type PayOrderRequest struct {
	...
	PaymentMethod PaymentMethod          `protobuf:"varint,3,opt,name=payment_method,json=paymentMethod,proto3,enum=repository.grpc.PaymentMethod" json:"payment_method,omitempty"`
...
const file_payment_v1_payment_proto_rawDesc = "" +
	"\n" +
	"\x18payment/grpc/repository.proto\x12\n" +
	"repository.grpc\"\x8f\x01\n" +
	"\x0fPayOrderRequest\x12\x1d\n" +
	"\n" +
	"order_uuid\x18\x01 \x01(\tR\torderUuid\x12\x1b\n" +
	"\tuser_uuid\x18\x02 \x01(\tR\buserUuid\x12@\n" +
	"\x0epayment_method\x18\x03 \x01(\x0e2\x19.repository.grpc.PaymentMethodR\rpaymentMethod\"=\n" +
	...
	"\bPayOrder\x12\x1b.repository.grpc.PayOrderRequest\x1a\x1c.repository.grpc.PayOrderResponseBQZOgithub.com/beachrockhotel/rocket-factory/shared/pkg/proto/repository/grpc;payment_v1b\x06proto3"
...
var file_payment_v1_payment_proto_goTypes = []any{
	(PaymentMethod)(0),       // 0: repository.grpc.PaymentMethod
	(*PayOrderRequest)(nil),  // 1: repository.grpc.PayOrderRequest
	(*PayOrderResponse)(nil), // 2: repository.grpc.PayOrderResponse
}
var file_payment_v1_payment_proto_depIdxs = []int32{
	0, // 0: repository.grpc.PayOrderRequest.payment_method:type_name -> repository.grpc.PaymentMethod
	1, // 1: repository.grpc.PaymentService.PayOrder:input_type -> repository.grpc.PayOrderRequest
	2, // 2: repository.grpc.PaymentService.PayOrder:output_type -> repository.grpc.PayOrderResponse
