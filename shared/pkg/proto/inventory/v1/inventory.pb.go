...
// Структура part описовающая деталь
type Part struct {
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x05parts\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x05parts\"j\n" +
	"\n" +
	"Dimensions\x12\x16\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBUZSgithub.com/beachrockhotel/rocket-factory/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	7,  // 1: inventory.v1.Part.dimensions:type_name -> inventory.v1.Dimensions
	8,  // 2: inventory.v1.Part.manufacturer:type_name -> inventory.v1.Manufacturer
	...
	4,  // 12: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	3,  // 13: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	6,  // 14: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse
