...
// versions:
// 	protoc-gen-go grpc.36.6
// 	protoc        (unknown)
// source: order/grpc/order.proto
...
type GetPartRequest struct {
	state         protoimpl.MessageState `protogen:"open.grpc"`
...
type Part struct {
	...
	Category      Category               `protobuf:"varint,6,opt,name=category,proto3,enum=order.grpc.Category" json:"category,omitempty"`
...
type PartsFilter struct {
	state                 protoimpl.MessageState    `protogen:"open.grpc"`
	Uuids                 []*wrapperspb.StringValue `protobuf:"bytes,1,rep,name=uuids,proto3" json:"uuids,omitempty"`
	Names                 []*wrapperspb.StringValue `protobuf:"bytes,2,rep,name=names,proto3" json:"names,omitempty"`
	Categories            []Category                `protobuf:"varint,3,rep,packed,name=categories,proto3,enum=order.grpc.Category" json:"categories,omitempty"`
	ManufacturerCountries []*wrapperspb.StringValue `protobuf:"bytes,4,rep,name=manufacturer_countries,json=manufacturerCountries,proto3" json:"manufacturer_countries,omitempty"`
	Tags                  []*wrapperspb.StringValue `protobuf:"bytes,5,rep,name=tags,proto3" json:"tags,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/grpc/order.proto\x12\forder.grpc\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"$\n" +
	"\x0eGetPartRequest\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\"9\n" +
	"\x0fGetPartResponse\x12&\n" +
	"\x04part\x18\x01 \x01(\v2\x12.order.grpc.PartR\x04part\"E\n" +
	"\x10ListPartsRequest\x121\n" +
	"\x06filter\x18\x01 \x01(\v2\x19.order.grpc.PartsFilterR\x06filter\"=\n" +
	"\x11ListPartsResponse\x12(\n" +
	"\x05parts\x18\x01 \x03(\v2\x12.order.grpc.PartR\x05parts\"\xd5\x04\n" +
	"\x04Part\x12\x12\n" +
	...
	"\bcategory\x18\x06 \x01(\x0e2\x16.order.grpc.CategoryR\bcategory\x128\n" +
	"\n" +
	"dimensions\x18\a \x01(\v2\x18.order.grpc.DimensionsR\n" +
	"dimensions\x12>\n" +
	"\fmanufacturer\x18\b \x01(\v2\x1a.order.grpc.ManufacturerR\fmanufacturer\x12\x12\n" +
	"\x04tags\x18\t \x03(\tR\x04tags\x12<\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2 .order.grpc.Part.MetadataEntryR\bmetadata\x129\n" +
	"\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x13.order.grpc.ValueR\x05value:\x028\x01\"j\n" +
	"\n" +
	"Dimensions\x12\x16\n" +
	...
	"\x04kind\"\xb4\x02\n" +
	"\vPartsFilter\x122\n" +
	"\x05uuids\x18\x01 \x03(\v2\x1c.google.protobuf.StringValueR\x05uuids\x122\n" +
	"\x05names\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueR\x05names\x126\n" +
	"\n" +
	"categories\x18\x03 \x03(\x0e2\x16.order.grpc.CategoryR\n" +
	"categories\x12S\n" +
	"\x16manufacturer_countries\x18\x04 \x03(\v2\x1c.google.protobuf.StringValueR\x15manufacturerCountries\x120\n" +
	"\x04tags\x18\x05 \x03(\v2\x1c.google.protobuf.StringValueR\x04tags*~\n" +
	"\bCategory\x12 \n" +
	...
	"\aGetPart\x12\x1c.order.grpc.GetPartRequest\x1a\x1d.order.grpc.GetPartResponse\x12L\n" +
	"\tListParts\x12\x1e.order.grpc.ListPartsRequest\x1a\x1f.order.grpc.ListPartsResponseBUZSgithub.com/beachrockhotel/rocket-factory/shared/pkg/proto/order/grpc;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	(Category)(0),                  // 0: order.grpc.Category
	(*GetPartRequest)(nil),         // 1: order.grpc.GetPartRequest
	(*GetPartResponse)(nil),        // 2: order.grpc.GetPartResponse
	(*ListPartsRequest)(nil),       // 3: order.grpc.ListPartsRequest
	(*ListPartsResponse)(nil),      // 4: order.grpc.ListPartsResponse
	(*Part)(nil),                   // 5: order.grpc.Part
	(*Dimensions)(nil),             // 6: order.grpc.Dimensions
	(*Manufacturer)(nil),           // 7: order.grpc.Manufacturer
	(*Value)(nil),                  // 8: order.grpc.Value
	(*PartsFilter)(nil),            // 9: order.grpc.PartsFilter
	nil,                            // 10: order.grpc.Part.MetadataEntry
	(*timestamppb.Timestamp)(nil),  // 11: google.protobuf.Timestamp
	(*wrapperspb.StringValue)(nil), // 12: google.protobuf.StringValue
}
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	5,  // 0: order.grpc.GetPartResponse.part:type_name -> order.grpc.Part
	9,  // 1: order.grpc.ListPartsRequest.filter:type_name -> order.grpc.PartsFilter
	5,  // 2: order.grpc.ListPartsResponse.parts:type_name -> order.grpc.Part
	0,  // 3: order.grpc.Part.category:type_name -> order.grpc.Category
	6,  // 4: order.grpc.Part.dimensions:type_name -> order.grpc.Dimensions
	7,  // 5: order.grpc.Part.manufacturer:type_name -> order.grpc.Manufacturer
	10, // 6: order.grpc.Part.metadata:type_name -> order.grpc.Part.MetadataEntry
	11, // 7: order.grpc.Part.created_at:type_name -> google.protobuf.Timestamp
	11, // 8: order.grpc.Part.updated_at:type_name -> google.protobuf.Timestamp
	12, // 9: order.grpc.PartsFilter.uuids:type_name -> google.protobuf.StringValue
	12, // 10: order.grpc.PartsFilter.names:type_name -> google.protobuf.StringValue
	0,  // 11: order.grpc.PartsFilter.categories:type_name -> order.grpc.Category
	12, // 12: order.grpc.PartsFilter.manufacturer_countries:type_name -> google.protobuf.StringValue
	12, // 13: order.grpc.PartsFilter.tags:type_name -> google.protobuf.StringValue
	8,  // 14: order.grpc.Part.MetadataEntry.value:type_name -> order.grpc.Value
	1,  // 15: order.grpc.InventoryService.GetPart:input_type -> order.grpc.GetPartRequest
	3,  // 16: order.grpc.InventoryService.ListParts:input_type -> order.grpc.ListPartsRequest
	2,  // 17: order.grpc.InventoryService.GetPart:output_type -> order.grpc.GetPartResponse
	4,  // 18: order.grpc.InventoryService.ListParts:output_type -> order.grpc.ListPartsResponse
