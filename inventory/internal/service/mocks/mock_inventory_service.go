...
func (_m *InventoryService) ListParts(_a0 context.Context, filter model.PartsFilter) ([]model.Part, error) {
...
func (_e *InventoryService_Expecter) ListParts(_a0 interface{}, filter interface{}) *InventoryService_ListParts_Call {
	return &InventoryService_ListParts_Call{Call: _e.mock.On("ListParts", _a0, filter)}
}

func (_c *InventoryService_ListParts_Call) Run(run func(_a0 context.Context, filter model.PartsFilter)) *InventoryService_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
