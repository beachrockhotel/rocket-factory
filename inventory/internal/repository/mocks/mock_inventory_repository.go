...
import (
	...
	model "github.com/beachrockhotel/rocket-factory/inventory/internal/model"
...
func (_m *InventoryRepository) ListParts(_a0 context.Context, filter model.PartsFilter) ([]model.Part, error) {
...
func (_e *InventoryRepository_Expecter) ListParts(_a0 interface{}, filter interface{}) *InventoryRepository_ListParts_Call {
	return &InventoryRepository_ListParts_Call{Call: _e.mock.On("ListParts", _a0, filter)}
}

func (_c *InventoryRepository_ListParts_Call) Run(run func(_a0 context.Context, filter model.PartsFilter)) *InventoryRepository_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
